...
export declare type Dim = 2 | 3 | 4;
export declare type DimMap<D extends Dim, D2, D3, D4> = D extends 4 ? D4 : never | D extends 3 ? D3 : never | D extends 2 ? D2 : never;
export declare type LowerDim<D extends Dim> = DimMap<D, never, 2, 3>;
export declare type HigherDim<D extends Dim> = DimMap<D, 3, 4, never>;
export declare type Component<D extends Dim> = DimMap<D, (0 | 1), (0 | 1 | 2), (0 | 1 | 2 | 3)>;
export declare type Tuple<T, D extends Dim> = DimMap<D, [T, T], [T, T, T], [T, T, T, T]>;
export declare type Vec<D extends Dim> = Tuple<number, D>;
export declare type VecDim<V extends Vec<any>> = V["length"];
export declare type SwizzleComponents<S extends Dim, D extends Dim> = Tuple<Component<S>, D>;
export declare type Vec2 = Vec<2>;
export declare type Vec3 = Vec<3>;
export declare type Vec4 = Vec<4>;
export declare type NumberArray = number[] | Float64Array | Float32Array | Int32Array | Int16Array | Int8Array | Uint32Array | Uint16Array | Uint8Array;
