...
export declare type Mat<D extends vec.Dim> = vec.Tuple<vec.Vec<D>, D>;
export declare type Mat2 = Mat<2>;
export declare type Mat3 = Mat<3>;
export declare type Mat4 = Mat<4>;
